    ...
    Chat = class Chat2 {
      ...
      onModelChange(model) {
        if (!model || !model.id) {
          ...
          this.chatModes = this.selectedModelDetails && Array.isArray(this.selectedModelDetails.chatModes) ? this.selectedModelDetails.chatModes : [];
      ...
      sendMessage() {
        if (!this.userMessage.trim() || this.isLoading || !this.userId || !this.chatSessionIdentity)
          return;
        ...
        this.chatService.sendMessage(this.userId, this.chatSessionIdentity, this.selectedModelId, msg, this.selectedChatMode).subscribe({
          next: (res) => {
            this.chatHistory.push({ role: "assistant", content: res.response, dateTime: (/* @__PURE__ */ new Date()).toISOString() });
      ...
      onNewChatSessionCreated(session) {
...
var require_chat_component_spec = __commonJS({
  "src/app/components/chat/chat.component.spec.ts"(exports) {
    init_testing();
...
//# sourceMappingURL=spec-app-components-chat-chat.component.spec.js.map
